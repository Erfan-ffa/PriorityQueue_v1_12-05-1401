        ...
        public void Dequeue()
        {
            if (!IsEmpty())
            {
                ...
                for (int i = 0; i < rear; i++)
                {
                    ...
                    {
                        MinimumItemindex = i + 1;
                    }
                }
                var minimumItem = "Poped Value : " + array[MinimumItemindex].Value + " Priortiy : " + array[MinimumItemindex].Priortiy;
                Console.WriteLine(minimumItem);

                array[MinimumItemindex] = array[rear];
                rear--;
            }
            else
            {
